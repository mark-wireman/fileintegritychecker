# Makefile for compiling File Integrity Checker in Azure
...
all: SQLHelper.o SHA256CPP.o Menu.o mysqlcontroller.o sqlite3controller.o fileintegritychecker.o
...
sqlite3controller.o: SQLHelper.o
	$(CC) -c -std=$(STDLIB) SQLHelper.o $(SRC_DIR)/sqlite3controller.cpp $(INCLUDES) $(CFLAGS) $(LIBS)
