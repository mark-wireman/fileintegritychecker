...
int SQLiteHelper::checkIfAttributeHasChanged(const int file_id, const AttributeToCheck attribute, const TableToCheck table, sqlite3* db, const char* char_attr, const int int_attr) {
    int retVal = 0;
...
int SQLiteHelper::checkIfAttributeIsInChanges(const int file_id, const AttributeToCheck attribute, sqlite3* db) {
    char* zErrMsg = 0;
    int rc;
    sqlite3_stmt* pStmt;
    char* sql_stmt;
...
int SQLiteHelper::didHashedValueChange(const char* hashed_val, TableToCheck table, const int file_id, sqlite3* db) {
    int retVal = 0;
...
int SQLiteHelper::didFileSizeChange(const int file_size, TableToCheck table, const int file_id, sqlite3* db) {
    int retVal = 0;
...
int SQLiteHelper::didDateModifiedChange(const char* date_modified, TableToCheck table, const int file_id, sqlite3* db) {
    int retVal = 0;
...
int SQLiteHelper::getDirectoryId(sqlite3* db, char* dir_name, char* machine_name) {
    int retVal = 0;
...
int SQLiteHelper::getFileId(sqlite3* db) {
    char* zErrMsg = 0;
    int rc;
    sqlite3_stmt* pStmt;
    int retVal = 0;
...
int SQLiteHelper::getFileId(sqlite3* db, char* file_name, int dir_id) {
    int retVal = 0;
 ...
 * @return char* 
 */
char* SQLiteHelper::getCurrentTime() {
    string retVal;
	char* char_array;
...
int SQLiteHelper::saveFileInfo(sqlite3* db, const int dir_id, const char* file_name, const int file_size, const char* date_modified, const char* hashed_val, const bool isNew, AttributeToCheck attr_to_update) {
    int retVal = 0;
    int hasChanged = 0;
...
int SQLiteHelper::saveNewFileInfo(sqlite3* db) {
    int retVal = 0;
    char* zErrMsg = 0;
    int rc;
    sqlite3_stmt* pStmt;
...
int SQLiteHelper::saveExistingFileInfo(sqlite3* db, AttributeToCheck attr_to_update, const char* text_val, const int int_val) {
    int retVal = 0;
...
int SQLiteHelper::updateChangedInFile(sqlite3* db, int file_id, AttributeToCheck attr_to_change) {
    char* zErrMsg = 0;
    int rc;
    sqlite3_stmt* pStmt;
    int retVal = 0;
