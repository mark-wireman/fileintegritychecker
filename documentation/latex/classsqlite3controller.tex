...
dirname&absolute path of the directory \\\cline{1-2}
...
machinename&name of the machine where the scanner is running. files -\/ used to store the details of the files found during the scan.\\\cline{1-2}
\end{longtabu}
